...
export default function Footer() {
  return (
    <footer className="bg-navy-950 text-white py-12 grain">
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-8 pb-8 border-b border-white/10">
          ...
          <div className="text-center md:text-left">
            <p className="text-xl font-display font-bold text-white mb-2">
              Built by <span className="text-accent-400">Christian Ojo</span>
            </p>
            <p className="text-navy-400 text-sm">
              Micro SaaS Builder • Based in Eswatini
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-navy-400">
          <p>
            © {new Date().getFullYear()} Christian Ojo. All rights reserved.
          </p>
          <div className="flex items-center gap-6">
